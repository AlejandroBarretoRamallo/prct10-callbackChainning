...
import { funkoType , FunkoPop} from './funkoPop.js';
import { gender } from './funkoPop.js';
import net from 'net'
...
export type promise = [string, number?, FunkoPop?]

export const checkPath = (user: string, id?: number, Funko?: FunkoPop): Promise<promise> => {
...
export const addFunko = (funko: FunkoPop, user: string): Promise<ResponseType> => {
  return new Promise((resolve, reject) => {
 ...
 * @param user - Username
 */
export const listFunko = (user: string): Promise<ResponseType> => {
  return new Promise((resolve, reject) => {
    let response: ResponseType = {
      success: true,
      error: ''
 ...
 */
export const deleteFunko = (user: string, id: number): Promise<ResponseType> => {
  return new Promise((resolve, reject) => {
    let response: ResponseType = {
      success: true,
      error: ''
 ...
 */
export const modifyFunko = (user: string, funko: FunkoPop): Promise<ResponseType> => {
  return new Promise((resolve, reject) => {
    let response: ResponseType = {
      success: true,
      error: ''
 ...
 * @param id Funko id
 */
export const showFunko = (user: string, id: number): Promise<ResponseType> => {
  return new Promise((resolve, reject) => {
    let response: ResponseType = {
      success: true,
      error: ''
